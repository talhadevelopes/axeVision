          ...
          {memberChoices.length > 0 ? (
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-heading text-slate-800 mb-2">Choose Your Profile</h3>
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                <h2 className="text-xl sm:text-2xl font-bold font-heading text-slate-800 mb-2">Welcome Back</h2>
